...
* [`notebook`](./ensembles_usrse_2025.ipynb)
...
3. Create environment from [`py312_livelike_usrse_2025_env.yaml`](./py312_livelike_usrse_2025_env.yaml).
   ```
   conda env create --file py312_livelike_usrse_2025_env.yaml
   ```
...
5. Launch Jupyterlab
   ...
   jupyter lab
   ```
6. Navigate into the Open and run notebook.
